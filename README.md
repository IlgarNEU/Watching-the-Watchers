...
@inproceedings{watchingthewatchers27,
  ...
  author={Ilgar Mammadov, Het Rutul Joshi, Daniel J. Dubois, David Choffnes},
...
2. The scripts do not require a special version of the listed operating systems, as long as Python 3 is available. They were tested using Python 3.13.7.
...
2) To support reproducibility, the necessary header fields are extracted and compressed into a .parquet file per smart TV. Each .parquet file is ~ 1GB. These files are stored on Zenodo: 
