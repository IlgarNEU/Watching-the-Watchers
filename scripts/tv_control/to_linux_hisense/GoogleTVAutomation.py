...
# ==========================================
TV_IP   = "192.168.14.134"   # Update to your TCL/Hisense IP
...
async def run_cmd(*args):
    for attempt in range(1, RUN_CMD_RETRIES + 1):
        ...
        if has_error:
            ...
            elif((len(args) > 1 and (args[1] == 'input')) or changing_input == True):
