...
import json
import os
from GoogleTVAutomation import *
...
experiment_logger.addHandler(
    logging.FileHandler(f"GOOGLETV_HIGHLEVEL_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log")
)
...
class AutomateGoogleTV:
    ...
    async def run_experiment(self):
        ...
        # power_off() now checks state first - safe to call unconditionally
        await power_off()
